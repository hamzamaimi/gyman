...
export const PASSWORD_NOT_SECURE = 'The password should be at least 8 characters, one uppercase and one special character.';
...
export const RESET_PASSWORD_ERROR = 'Error during reset password.';
export const RESET_PASSWORD_ALREADY_SENT = 'Wait some hours between password reset requests.';